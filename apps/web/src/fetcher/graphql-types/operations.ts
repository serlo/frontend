...
export type InjectionOnlyContentQuery = { __typename?: 'Query', uuid?: { __typename: 'Applet', id: string, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'AppletRevision', content: string, url: string } | null } | { __typename: 'AppletRevision', alias: string, title: string } | { __typename: 'Article', id: number, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'ArticleRevision', content: string } | null } | { __typename: 'ArticleRevision', alias: string, title: string } | { __typename: 'Comment', alias: string, title: string } | { __typename: 'Course', id: number, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'CourseRevision', content: string } | null } | { __typename: 'CoursePage', id: number, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'CoursePageRevision', content: string } | null } | { __typename: 'CoursePageRevision', alias: string, title: string } | { __typename: 'CourseRevision', alias: string, title: string } | { __typename: 'Event', id: number, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'EventRevision', content: string } | null } | { __typename: 'EventRevision', alias: string, title: string } | { __typename: 'Exercise', id: number, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'ExerciseRevision', content: string } | null } | { __typename: 'ExerciseGroup', id: number, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'ExerciseGroupRevision', content: string } | null } | { __typename: 'ExerciseGroupRevision', alias: string, title: string } | { __typename: 'ExerciseRevision', alias: string, title: string } | { __typename: 'Page', alias: string, title: string } | { __typename: 'PageRevision', alias: string, title: string } | { __typename: 'TaxonomyTerm', alias: string, title: string } | { __typename: 'User', alias: string, title: string } | { __typename: 'Video', id: string, licenseId: number, alias: string, title: string, currentRevision?: { __typename?: 'VideoRevision', content: string, url: string } | null } | { __typename: 'VideoRevision', alias: string, title: string } | null };
