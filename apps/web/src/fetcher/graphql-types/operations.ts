...
export type ArticleRevisionFragment = { __typename?: 'ArticleRevision', metaTitle: string, metaDescription: string };

export type VideoRevisionFragment = { __typename?: 'VideoRevision', url: string };

export type AppletRevisionFragment = { __typename?: 'AppletRevision', url: string, metaTitle: string, metaDescription: string };

export type CoursePageRevisionFragment = { __typename?: 'CoursePageRevision', alias: string };
