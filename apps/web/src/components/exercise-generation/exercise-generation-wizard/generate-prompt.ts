...
Stelle die Aufgabe zum Hochladen auf eine Lernplattform in einem unnamed JSON Objekt dar. Füge eine sinnvolle Überschrift zu ${generatedExerciseSingularOrPlural} als value zu dem key "heading" hinzu. Die weiteren key value pairs werden alle in ein array mit dem key "exercises" geschrieben, sodass das JSON so aussieht { "heading": "Relevanter Titel für die generierten Aufgaben", "exercises": [] }. Alle weiteren key-value pairs müssen sich in dem "exercises" Array befinden! ${solutionSteps}
