...
export const FillInTheGapExample = (
  <div className="flex flex-col gap-2 pt-2">
    ...
    />
    <h1 className="ml-side text-xl font-bold">Exercise with table input</h1>
    <StaticRenderer
      document={parseDocumentString(
        '{"plugin":"rows","state":[{"plugin":"exercise","state":{"content":{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"p","children":[{"text":"Ordne die abgebildeten Funktionsgraphen von "},{"type":"math","src":"f, g","inline":true,"children":[{"text":""}]},{"text":" und "},{"type":"math","src":"h","inline":true,"children":[{"text":""}]},{"text":" den angegebenen Gleichungen zu. "},{"text":"(2 P)","strong":true}]},{"type":"p","children":[{"strong":true,"text":""}]}]},{"plugin":"image","state":{"src":"https://assets.serlo.org/841e1050-fe22-11ee-8e32-8b5c481d277e/image.png","caption":{"plugin":"text","state":[{"type":"p","children":[{"text":""}]}]}}}]},"interactive":{"plugin":"blanksExercise","state":{"text":{"plugin":"serloTable","state":{"rows":[{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"Graph"}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"Gleichung"}]}]}}]},{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":""},{"type":"textBlank","blankId":"854bf23d-14f0-4d2a-baa2-520d1b00500f","correctAnswers":[{"answer":"u"}],"acceptMathEquivalents":true,"children":[{"text":""}]},{"text":" "}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"","strong":true},{"type":"math","src":"y=-0,5x+2","inline":true,"children":[{"text":""}]},{"text":""}]}]}}]},{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":""},{"type":"textBlank","blankId":"3769cfde-4c81-4aa4-8449-d0981ce67804","correctAnswers":[{"answer":"h"}],"acceptMathEquivalents":true,"children":[{"text":""}]},{"text":" "}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"","strong":true},{"type":"math","src":"y=0,5x+3","inline":true,"children":[{"text":""}]},{"text":""}]}]}}]},{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":""},{"type":"textBlank","blankId":"433edb02-d0dd-45fd-9e1c-e76b548de8ac","correctAnswers":[{"answer":"f"}],"acceptMathEquivalents":true,"children":[{"text":""}]},{"text":" "}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"","strong":true},{"type":"math","src":"y=2x+3","inline":true,"children":[{"text":""}]},{"text":""}]}]}}]}],"tableType":"OnlyColumnHeader"}},"mode":"typing"}},"solution":{"plugin":"solution","state":{"strategy":{"plugin":"text","state":[{"type":"p","children":[{"text":"Untersuche die verschiedenen Graphen auf:"}]},{"children":[{"children":[{"type":"list-item-child","children":[{"text":"den y-Achsenabschnitt"},{"type":"math","src":"\\\\textbf{b}","inline":true,"children":[{"text":""}]},{"text":""}]}],"type":"list-item"},{"children":[{"children":[{"text":"die Steigung"},{"type":"math","src":"\\\\textbf{m}","inline":true,"children":[{"text":""}]},{"text":""}],"type":"list-item-child"}],"type":"list-item"}],"type":"unordered-list"},{"children":[{"text":"entscheide dann, welcher Graph zu welcher Gleichung passt."}],"type":"p"}]},"steps":{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"h","children":[{"text":"Allgemeine Geradengleichung:"}],"level":3},{"type":"p","children":[{"text":""},{"type":"math","src":"\\\\hspace{20mm}\\\\bold{\\\\mathrm{f(x)=mx+b}}","inline":true,"children":[{"text":""}]},{"text":""}]}]},{"plugin":"serloTable","state":{"rows":[{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":""},{"type":"math","src":"\\\\bold{\\\\mathrm{f(x)}}","inline":true,"children":[{"text":""}]},{"text":""}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"Steigung m"}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"y-Achsenabschnitt b"}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"Graph"}]}]}}]},{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"-0,5x+2","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"-0,5","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"2","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"g","strong":true}]}]}}]},{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"0,5x+3","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"0,5","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"3","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"h","strong":true}]}]}}]},{"columns":[{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"2x+3","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"2","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"3","strong":true}]}]}},{"content":{"plugin":"text","state":[{"type":"p","children":[{"text":"f","strong":true}]}]}}]}],"tableType":"OnlyColumnHeader"}}]},"prerequisite":{"id":"2005","title":"Lineare Funktion"}}},"licenseId":27}}]}'
      )}
    />
