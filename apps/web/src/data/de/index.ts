...
export const instanceData = {
  ...
  strings: {
    ...
    notices: {
      ...
      warningLoggedOut:
        '⚠️ Du wurdest abgemeldet. Bitte melde dich wieder an und benutze dann "Änderungen laden" um deine aktuellen Änderungen wiederherzustellen.',
      revisionSaved:
    ...
    auth: {
      ...
      register: {
        ...
        newsletterSubscription:
          'Erhalte in unserem Newsletter kompakte Updates zu unseren aktuellen Aktivitäten. Deine Angaben nutzen wir für den Versand und für persönliche Anreden. Freue dich auf relevante Informationen und einmal jährlich auf unsere Spendenkampagne. (optional)',
      },
      ...
      messages: {
        ...
        code4070005:
          'Dieser Bestätigungslink ist leider nicht mehr gültig. Bitte versuche eine neue E-Mail anzufordern.',
      },
      usernameInvalid:
        'Der Benutzername darf nur aus Buchstaben, Ziffern, Unterstrichen (_) und Bindestrichen (-) bestehen.',
      usernameTooLong:
        'Sorry, dieser Benutzername ist zu lang. 32 Zeichen oder weniger sind erlaubt.',
      passwordTooShort:
      ...
      consentNeededBeforeProceeding:
        'Wir brauchen dein Einverständnis, um fortzufahren.',
  ...
  strings: {
    ...
    editor: {
      ...
      plugins: {
        ...
        rows: {
          title: 'Zusätzliche Aufgabenstellung',
      ...
      edtrIo: {
        ...
        anchorLinkWarning:
          'Dieser Link funktioniert nur im Frontend und für Inhalte, die eine etwas relativ neue akzeptierte Bearbeitung haben.',
    ...
    ai: {
      exerciseGeneration: {
        ...
        confirmCloseDescription:
          'Möchtest du die Aufgabenerstellung verlassen? Die Daten werden gelöscht.',
        ...
        hallucinationWarning:
          'Die KI kann inkorrekte Lösungen erstellen. Bitte überprüfe die Inhalte.',
        topic: {
        ...
        difficulty: {
          ...
          learningGoalExample:
            'Beispiel: Schüler*innen verstehen die Grundlagen von Algebra.',
        ...
        priorKnowledge: {
          ...
          label: 'Vorwissen',
          example:
            'Beispiel: Die Schüler*innen haben schon einige Aufgaben zu dem Thema bearbeitet.',
