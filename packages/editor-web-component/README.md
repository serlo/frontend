...
Version 0.10.3 was the last stable version where you can render the Serlo Editor within the Shadow DOM. All future versions will only work in the regular DOM and expects window/document objects to be available! If you are already rendering the Serlo within a Shadow Root, you could consider wrapping the Serlo Editor in an iFrame which should make the global window/document objects available while isolating our styles completely.
