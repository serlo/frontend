...
export function EditorTextArea({
  ...
  return (
    <div className={cn('flex flex-row items-stretch gap-3 ', className)}>
      <textarea
        placeholder={placeholder}
        className={cn(
          'text-area-chrome-autogrow flex-grow resize-none rounded-xl border-2 border-editor-primary-200 bg-editor-primary-100 px-2 py-1 text-almost-black focus:border-editor-primary focus:outline-none'
        )}
        value={value}
        onChange={onChange}
      ></textarea>
