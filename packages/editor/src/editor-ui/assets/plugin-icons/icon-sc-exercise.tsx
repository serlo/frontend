export function SCExerciseIcon() {
  return (
    ...
    >
      <g clipPath="url(#clip0_10649_33092)">
        <rect width="90" height="60" fill="#FFEFDA" />
        <circle cx="28" cy="16" r="4.5" fill="#FFBE5D" stroke="#FFBE5D" />
        <path
          d="M27.1132 17.6227L25.8842 16.3937C25.7461 16.2556 25.523 16.2556 25.3848 16.3937C25.2467 16.5318 25.2467 16.7549 25.3848 16.8931L26.8653 18.3735C27.0034 18.5116 27.2265 18.5116 27.3646 18.3735L31.1117 14.6264C31.2498 14.4883 31.2498 14.2652 31.1117 14.127C30.9736 13.9889 30.7505 13.9889 30.6123 14.127L27.1132 17.6227Z"
          fill="white"
        />
