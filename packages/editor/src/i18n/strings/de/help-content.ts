export const pluginHelpContent = {
  ...
  highlight: {
    ...
    shortExplanation:
      'Du kannst Code in diverse Programmiersprachen verfassen und ihn somit direkt zum Unterrichtsgegenstand machen.',
  },
  equations: {
    video:
      'https://editor.serlo.dev/media/serlo-org/z87fdcl76gvtkdgny1o4qgyg/video.webm',
    shortExplanation:
      'Du kannst schnell einfache oder komplexe Term- und Gleichungsumformungen anfertigen und Erklärungen zu den einzelnen Schritten hinzufügen. Die Formeln lassen sich visuell oder mithilfe von LaTex erstellen.',
  },
  geogebra: {
    video:
  ...
  spoiler: {
    ...
    shortExplanation:
      'Du kannst mit der ausklappbaren Box “Spoiler” Inhalte für den ersten Blick verstecken. Der Spoiler bietet sich z.B. für inhaltliche Exkurse an oder Lösungshinweise. Das Einfügen unterschiedlicher Elemente im Spoiler ist möglich.',
  },
  serloTable: {
    video:
      'https://editor.serlo.dev/media/serlo-org/dhwzrf1uv8bwoxk7uzharu4e/video.webm',
    shortExplanation:
      'Du kannst individualisierte Tabellen erstellen. Sowohl Zeilen- als auch Spaltentitel können eingestellt werden. Es ist möglich, Text oder Bilder in die Zellen hinzuzufügen.',
  },
  text: {
    video:
  ...
  inputExercise: {
    ...
    shortExplanation:
      'Aufgabe mit einem Eingabefeld, in das ein Wert oder eine Zeichenfolge eingegeben und validiert werden kann. Du kannst für bestimmte Antworten individuelles Feedback hinzufügen, um beispielsweise Missverständnisse hinter häufigen Fehlern zu erklären.',
  },
  scMcExercise: {
    video:
  ...
  dropzoneImage: {
    ...
    shortExplanation:
      'Lernende können vorgegebene Antworten per Drag & Drop in Zonen eines Bildes oder leeren Inhalts ziehen und erhalten darauf Feedback. Du kannst zusätzliche falsche Antworten hinzufügen, um die Übung herausfordernder zu gestalten.',
  },
  h5p: {
    shortExplanation:
