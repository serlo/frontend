...
export declare const textSolutionTypeState: import("@edtr-io/plugin").StateType<import("@edtr-io/internal__plugin-state").StateTypesSerializedType<{
...
export declare type TextSolutionTypeProps = EditorPluginProps<typeof textSolutionTypeState, {
    skipControls: boolean;
}>;
export declare const textSolutionTypePlugin: EditorPlugin<typeof textSolutionTypeState, {
    skipControls: boolean;
}>;
//# sourceMappingURL=text-solution.d.ts.map