...
export declare const videoTypeState: import("@edtr-io/plugin").StateType<import("@edtr-io/internal__plugin-state").StateTypesSerializedType<{
...
export declare const videoTypePlugin: EditorPlugin<typeof videoTypeState>;
