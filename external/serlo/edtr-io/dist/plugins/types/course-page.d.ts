...
export declare const coursePageTypeState: import("@edtr-io/plugin").StateType<import("@edtr-io/internal__plugin-state").StateTypesSerializedType<{
    icon: import("@edtr-io/plugin").StateType<string, string, {
        value: string;
        get(): string;
...
export declare const coursePageTypePlugin: EditorPlugin<typeof coursePageTypeState, {
    skipControls: boolean;
}>;
//# sourceMappingURL=course-page.d.ts.map