...
export declare const mathPuzzleTypeState: import("@edtr-io/plugin").StateType<import("@edtr-io/internal__plugin-state").StateTypesSerializedType<{
    source: import("@edtr-io/plugin").StateType<string, string, {
        value: string;
        get(): string;
...
export declare const mathPuzzleTypePlugin: EditorPlugin<typeof mathPuzzleTypeState>;
//# sourceMappingURL=math-puzzle.d.ts.map