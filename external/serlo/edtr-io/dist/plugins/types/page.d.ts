...
export declare const pageTypeState: import("@edtr-io/plugin").StateType<import("@edtr-io/internal__plugin-state").StateTypesSerializedType<{
...
export declare const pageTypePlugin: EditorPlugin<typeof pageTypeState>;
