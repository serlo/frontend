    ...
    state: {
      data: {
        uuid: {
          title: 'Kulla',
          description:
            '{"id":"3ec1a50b-cc32-40cc-98ed-37d0632659af","type":"https://serlo.org/editor","variant":"serlo-org","domainOrigin":"serlo.org","version":2,"editorVersion":"0.22.0","dateModified":"2025-02-18T15:33:17.351Z","document":{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"p","children":[{"text":"Hallo, mein Name ist Kulla und ich engagiere mich bereits seit 10 Jahren bei Serlo. Früher habe ich vor allem Inhalte zur Hochschulmathematik erstellt und habe mitgeholfen, diesen Bereich bei Serlo aufzubauen. Aktuell arbeite ich hauptamtlich als Programmierer bei Serlo und erstelle in meiner Freizeit vor allem Inhalte im Physik- und im Mathematikbereich."}]}],"id":"cad1f88f-19ce-4487-93b8-1c5f66e0b4b2"}],"id":"c0022339-4197-4ead-893d-c4775fc6b256"}}',
        },
      },
    },
  },
