      ...
      data: {
        uuid: {
          ...
          currentRevision: {
            ...
            changes: '[test-edit]',
            content:
              '{"plugin":"course","state":{"content":{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"p","children":[{"text":""}]}],"id":"efd0d991-f678-41ef-aff0-4ad142aa7a9a"}],"id":"75918399-2532-427f-bb51-00110917fb99"},"pages":[{"id":"","title":"Page 1","content":{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"p","children":[{"text":"hello bird"}]}],"id":"da15f782-3073-4872-bd50-6dd140a371ac"}],"id":"ff10d59c-b692-4127-89cc-435c14584894"}}]},"id":"a901b330-fb5a-427f-93af-ebffd04c927c"}',
          },
        },
      },
    },
      ...
      data: {
        uuid: {
          ...
          currentRevision: {
            ...
            changes: '[test-edit]',
            content:
              '{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"p","children":[{"text":"hello worm"}]}],"id":"e0e37648-b3e9-4561-8e4a-9489b6cb2855"}],"id":"31e0cb90-06af-4acb-9f33-49c0c7e131b7"}',
          },
        },
      },
    },
      ...
      data: {
        uuid: {
          ...
          currentRevision: {
            ...
            changes: '[test-edit]',
            content:
              '{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"p","children":[{"text":"hello dear"}]}],"id":"d0ed47cb-cc84-481b-bb3b-aaa5ce89a345"}],"id":"bef6f320-7de7-4e22-b063-4e18b1d2b161"}',
          },
        },
      },
    },
    ...
    state: {
      data: {
        uuid: {
          ...
          description:
            '{"plugin":"rows","state":[{"plugin":"text","state":[{"type":"p","children":[{"text":"without Page, Event, User …"}]}],"id":"8f68e62f-7018-4a16-9c82-2ba4f44fb109"}],"id":"569e3c8b-d83c-4a5b-a214-a6709b265523"}',
          weight: 4,
          parent: {
            id: 234582,
          },
...
Scenario('Save Entities and check results', ({ I }) => {
  ;['Article', 'Course', 'Video', 'Applet', 'Event'].forEach((type) => {
    I.say(`Type: ${type}`)
