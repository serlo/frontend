...
export const instanceData = {
  ...
  strings: {
    ...
    unrevisedRevisions: {
      ...
      help2: 'Alle können mit einem Klick auf %eyeIcon% Bearbeitungen anschauen und weiter bearbeiten. Als Reviewer*in kannst du die Bearbeitung dort auch übernehmen und Feedback geben.',
      help3: 'Du möchtest Reviewer*in werden? Melde dich bei: %userlink%',
