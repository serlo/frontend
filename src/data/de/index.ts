...
export const instanceData = {
  ...
  strings: {
    ...
    events: {
      ...
      setThreadStateArchived: "%actor% hat %thread% archiviert.",
      setThreadStateUnarchived: "%actor% hat %thread% aus dem Archiv geholt.",
      createComment: "%actor% hat %comment% in %thread% erstellt.",
      createThread: "%actor% hat %thread% in %object% erstellt.",
      ...
      createEntityRevision: "%actor% hat %revision% von %entity% erstellt.",
      checkoutRevision: "%actor% hat %revision% von %repository% übernommen.",
      rejectRevision: "%actor% hat %revision% in %repository% nicht übernommen.",
      createTaxonomyLink: "%actor% hat %child% in %parent% eingeordnet.",
      removeTaxonomyLink: "%actor% hat %child% aus %parent% entfernt.",
      createTaxonomyTerm: "%actor% hat %term% erstellt.",
      setTaxonomyTerm: "%actor% hat %term% geändert.",
