...
export const instanceData = {
  ...
  strings: {
    ...
    profiles: {
      ...
      invitation:
        ' ¡💬 %username%  te ha invitado a la comunidad del chat de Serlo!\nVe a %chatlink% para unirte.',
      inviteModal: {
        part1:
          '%username%  aún no está activo/a en nuestra comunidad del chat en %chatLink%.',
        part2:
          'Puedes invitar a %username% al chat para enviar mensajes directos: ',
    ...
    events: {
      ...
      inviteToChat:
        '¡Has sido invitado al chat! %break% Ve a %chatLink% para chatear con %actor% y otras/os.',
  ...
  strings: {
    ...
    editor: {
      ...
      article: {
        ...
        exFolderId: "ID de una carpeta de ejercicios, ej. 30560",
        openExerciseTab: "Abrir la carpeta de ejercicios en una nueva pestaña:"
      },
      coursePage: {
