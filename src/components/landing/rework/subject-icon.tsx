...
export function SubjectIcon({
  ...
  return (
    <div className="serlo-subject-icon-wrapper">
        ...
        <>
          ...
          <style jsx global>{`
            ...
            .serlo-subject-icon-wrapper:hover
              .superspecial-informatics
              .eye-closed,
            .serlo-subject-icon-wrapper:hover .superspecial-informatics .sound,
            .serlo-subject-icon-wrapper:focus
              .superspecial-informatics
              .eye-closed,
            .serlo-subject-icon-wrapper:focus .superspecial-informatics .sound,
            .serlo-subject-icon-wrapper:active
              .superspecial-informatics
              .eye-closed,
            .serlo-subject-icon-wrapper:active
        ...
        <>
          ...
          <style jsx global>
            {`
              ...
              .serlo-subject-icon-wrapper:active .superspecial-chem .contents {
