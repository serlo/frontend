        ...
        <div>
          ...
          {attributes.type === 'password' ? (
            <>
              ...
              />
              <PasswordRequirements flowType={flowType} />
            </>
          ) : null}
          {messages}
        </div>
...
interface ShowOrHidePasswordProps {
  showPassword: boolean
...
function PasswordRequirements({ flowType }: { flowType: FlowType }) {
  const { strings } = useInstanceData()
