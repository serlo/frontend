...
import AuthorBadge from '@/assets-webkit/img/badge-author.svg'
import DonorBadge from '@/assets-webkit/img/badge-donor.svg'
import ReviewerBadge from '@/assets-webkit/img/badge-reviewer.svg'
  ...
  return (
    <>
      <Link href={`/user/profile/${user.id}`}>
        {withIcon && <FontAwesomeIcon icon={faUser} />}
        {user.username}
        {renderBadges()}
      </Link>
    </>
