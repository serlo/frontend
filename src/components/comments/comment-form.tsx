  ...
  return (
    <div
      className={clsx(
        ...
        'bg-brandgreen-lighter',
        'border-2 border-brandgreen-lighter focus-within:border-brandgreen-muted',
    ...
    >
      ...
      <TextareaAutosize
        ...
        className={clsx(
          ...
          'text-black border-0 bg-transparent focus:outline-none resize-none',
