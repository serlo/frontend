...
import { entity } from '../../serlo-editor/plugins/serlo-types-plugins/common/common'
import { useHandleSave } from '../../serlo-editor/plugins/serlo-types-plugins/helpers/use-handle-save'
