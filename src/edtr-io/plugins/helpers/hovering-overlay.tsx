...
export interface HoveringOverlayProps {
  children: React.ReactNode
  position: HoverPosition
  anchor?: React.RefObject<HTMLElement>
}

// TODO: duplicate of src/serlo-editor-repo/editor-ui/hover-overlay.tsx
export function HoveringOverlay(props: HoveringOverlayProps) {
