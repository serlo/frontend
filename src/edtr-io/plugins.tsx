...
import { createAnchorPlugin } from 'test-edtr-io/plugin-anchor'
import { createBlockquotePlugin } from 'test-edtr-io/plugin-blockquote'
import { createGeogebraPlugin } from 'test-edtr-io/plugin-geogebra'
import {
  createInputExercisePlugin,
  InputExerciseType,
} from 'test-edtr-io/plugin-input-exercise'
import { createMultimediaExplanationPlugin } from 'test-edtr-io/plugin-multimedia-explanation'
import { createRowsPlugin, RowsConfig } from 'test-edtr-io/plugin-rows'
import { createScMcExercisePlugin } from 'test-edtr-io/plugin-sc-mc-exercise'
import { createSpoilerPlugin } from 'test-edtr-io/plugin-spoiler'
import { createTextPlugin } from 'test-edtr-io/plugin-text'
