...
type Exercise_Exercise_Fragment = { __typename?: 'Exercise', id: number, alias: string, instance: Instance, trashed: boolean, date: string, currentRevision?: { __typename?: 'ExerciseRevision', id: number, content: string, date: string } | null, license: { __typename?: 'License', id: number, url: string, title: string, shortTitle: string, default: boolean, agreement: string } };

type Exercise_GroupedExercise_Fragment = { __typename?: 'GroupedExercise', id: number, alias: string, instance: Instance, trashed: boolean, date: string, currentRevision?: { __typename?: 'GroupedExerciseRevision', id: number, content: string, date: string } | null, license: { __typename?: 'License', id: number, url: string, title: string, shortTitle: string, default: boolean, agreement: string } };
