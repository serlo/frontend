...
export default renderedPageNoHooks<TmpProps>((props) => {
  return (
    <FrontendClientBase
      noContainers
    ...
    >
      <div className="relative">
        <MaxWidthDiv>
          <main>
            <Content editorState={props.editorState} />
          </main>
        </MaxWidthDiv>
      </div>
    </FrontendClientBase>
...
export const getStaticProps: GetStaticProps<TmpProps> = async () => {
  ...
  const solutionMockState = parseDocumentString(
